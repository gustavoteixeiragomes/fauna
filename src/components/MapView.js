...
export default class MapView extends Component {
  ...
  getMarkers(item={}) {
    ...
    const url = `${action}?geo=true&mappable=true&photos=true&iconic_taxa=${iconic_taxa}&taxon_id=${taxon_id}&search_on=${search_on}&order=${order}&order_by=${order_by}&page=${page}&per_page=${per_page}&swlng=${swlng}&swlat=${swlat}&nelng=${nelng}&nelat=${nelat}&captive=${captive}`;
